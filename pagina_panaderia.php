<?php 
	...
	if(!isset($_SESSION['troles'])) {
		include 'Actions/IniciarSesion/PagePanaderia.php';
                                    ...
                                    <ul class="navbar-nav mx-auto" id="menuresponsive">
                                        ...
                                        <li id="list_menu" class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                <li><a class="dropdown-item" href="#Panques">Panqués</a></li>
							                    <li><a class="dropdown-item" href="#Galletas">Galletas</a></li>
							                    <li><a class="dropdown-item" href="#Brownies">Brownies</a></li>
							                    <li><a class="dropdown-item" href="#Donas">Donas</a></li>
                                            </ul>
                                        </li>
...
<!-------------------------------------------------- CUERPO ---------------------------------------------------------------->
		<div id="cuerpo">
			...
			<div id="Panques" class="etiquetas_page">Panqués</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_panques.php';?>
			</div>

			<div id="Galletas" class="etiquetas_page">Galletas</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_galletas.php';?>
			</div>

			<div id="Brownies" class="etiquetas_page">Brownies</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_brownies.php';?>
			</div>

			<div id="Donas" class="etiquetas_page">Donas</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_donas.php';?>
			</div>
