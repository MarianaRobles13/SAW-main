	...
	<div class="ventana" id="vent">
		...
		<div id="cuerpo">
                    <div id="contenedor_botones_pedidos">
                        ...
                        <div class="boton_pedido"><a class="Selected" href="usuarios_pedidos.php">Recibidos</a></div>
		...
		<tr><th colspan="9"><h1>Lista de pedidos registrados</h1></th></tr>
		<tr>
			<th>N. Ticket</th>
			<th>Articulo</th>
		...
		<?php 
			...
			$query = mysqli_query($conexion, "SELECT tventas.id_NTicket, tventas.Cantidad_soli, tventas.Subtotal, tventas.IVA, tventas.Total, tventas.Estado_pedido, tventas.Fecha_pedido,
                                                    ...
                                                    WHERE tventas.Estado_pedido = 0 ORDER BY tventas.Fecha_pedido ASC/*LIMIT $desde,$por_pagina*/");
