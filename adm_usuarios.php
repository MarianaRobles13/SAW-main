...
<head>
	...
	<div class="ventana" id="vent">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
						  <li><a class="dropdown-item" href="adm_usuarios.php"><div class="pageSelected">Adm. Usuarios</div></a></li>
        ...
        <table id="tabla1">
		<tr><th colspan="11"><h1>Lista de usuarios registrados</h1></th></tr>
		<tr>
			<th rowspan="2">Nombre</th>
			<th rowspan="2">Apellido</th>
            <th rowspan="2">Telefono</th>
			<th rowspan="2">Email / Correo</th>
		...
		<?php 
			...
			$query = mysqli_query($conexion, "SELECT tusuarios.id, tusuarios.Nombre, tusuarios.Apellido, tusuarios.Username, tusuarios.Contrasena, tusuarios.CalleYNumero,
													tusuarios.TColonias_id, troles.Rol, ttelefonosusr.Telefono, temailusr.Email, tcolonias.Colonia, tcpostales.CPostal, tciudades.Ciudad,
													testados.Estado, tpaises.Pais FROM tusuarios 
                                                    ...
                                                    INNER JOIN tpaises ON testados.TPaises_id = tpaises.id ORDER BY tusuarios.id ASC/*LIMIT $desde,$por_pagina*/");
			...
			if($result > 0){
				...
				<tr>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Nombre"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Apellido"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Telefono"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Email"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Username"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Contrasena"]; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["CalleYNumero"].", ".$data["CPostal"].", ".$data["Colonia"].", ".$data["Ciudad"].", ".$data["Estado"].", ".$data["Pais"]."."; ?></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><?php echo $data["Rol"]; ?></td>

					<td style="background: #c7d0eb; color: rgb(0 0 0);"><a href="editar_usuarios.php?id=<?php echo $data["id"]; ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
					<td style="background: #c7d0eb; color: rgb(0 0 0);"><a href="eliminar_usuarios.php?id=<?php echo $data["id"]; ?>" onclick="return confirmacion()"><i class="fa-solid fa-trash-can"></i></a></td>
				</tr>	
			<?php
					}else{
			?>
				<tr>
					...
					<td><a href="editar_usuarios.php?id=<?php echo $data["id"]; ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
					<td><a href="eliminar_usuarios.php?id=<?php echo $data["id"]; ?>" onclick="return confirmacion()"><i class="fa-solid fa-trash-can"></i></a></td>
				</tr>	
			<?php
					}
				}
