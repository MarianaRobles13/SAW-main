				...
				<fieldset>
					<table>
						...
						<tr>
							...
							<td><input type="number" name="NPersonas" id="NPersonas" value="<?php echo $data_producto['NPersonas']; ?>" placeholder="Ingrese una medida en numero de personas" required></td>
						</tr>
						<tr>
