<?php 
	...
	if(empty($_REQUEST['id'])){
		...
		$query_producto = mysqli_query($conexion, "SELECT tarticulos.id, tarticulos.Nombre, tarticulos.Stock, tarticulos.Cantidad, tarticulos.Descripcion, tarticulos.Precio, 
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a id="op_menu" class="nav-link" href="registros_panaderia.php">Regresar</a>
					</li>
				</ul>
			</div>
