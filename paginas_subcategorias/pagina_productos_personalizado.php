...
<?php
	...
	WHERE tarticulos.Stock = 1 AND tarticulos.TSubCategoria_id = 6 ORDER BY tarticulos.Nombre ASC");
			...
			<div class="card" id="tarjetas">
				<img class="imagen_tarjeta" class="card-img-top" src="<?php echo $foto; ?>" alt="<?php echo $data["Nombre"]; ?>">
					...
					<?php 	if(isset($_SESSION['troles'])){ ?>
						<a href="pagina_pedidos_pasteleria.php?id=<?php echo $data["id"]; ?>" class="boton">Solicitar</a>
					<?php	}else{ ?>
