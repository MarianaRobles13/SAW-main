...
<?php 
	if (isset($_GET["id"])) {
		...
		$eliminar=mysqli_query($conexion, "DELETE tcontacto
											FROM `tcontacto`
											WHERE id = '$id'");
				
		echo "<h2 id='eliminado'>Mensaje eliminado con éxito  <a class='btn' href='registros_mensajes.php'><button class='btn'>Aceptar</button></a></h2>";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a id="op_menu" class="nav-link" href="registros_mensajes.php">Regresar</a>
					</li>
				</ul>
			</div>
