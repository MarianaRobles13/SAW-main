	...
	<div class="ventana" id="vent">
		...
		<div id="cuerpo">
					<div id="contenedor_botones_pedidos">
                        <div class="boton_pedido_cancelado"><a class="Selected" href="usuarios_pedidos_cancelados.php">Cancelados</a></div>
                        <div class="boton_pedido"><a href="usuarios_pedidos.php">Recibidos</a></div>
                        <div class="boton_pedido_completado"><a href="usuarios_pedidos_completados.php">Completados</a></div>
                    </div>


		<div id="tabla_registros">
        <table id="tabla1" class="tabla_pedidos">
		<tr><th colspan="10"><h1>Lista de pedidos cancelados</h1></th></tr>
		<tr>
			<th>N. Ticket</th>
			<th>Articulo</th>
		...
		<?php 
			...
			$query = mysqli_query($conexion, "SELECT tventas.id_NTicket, tventas.Cantidad_soli, tventas.Subtotal, tventas.IVA, tventas.Total, tventas.Estado_pedido, tventas.Fecha_pedido,
                                                    ...
                                                    WHERE tventas.Estado_pedido = 1 ORDER BY tventas.Fecha_pedido ASC/*LIMIT $desde,$por_pagina*/");
