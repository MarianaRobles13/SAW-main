...
<head>
	...
	<div class="ventana" id="vent">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a id="op_menu_backend" class="nav-link" href="registros_pasteleria.php"><div class="pageSelected">Pastelería</div></a>
					</li>
        ...
        <table id="tabla1">
		<tr><th colspan="12"><h1>Productos de pasteleria registrados</h1></th></tr>
		<tr>
			<th rowspan="2">Nombre</th>
			<th rowspan="2">Stock</th>
			<th rowspan="2">Cantidad</th>
			<th rowspan="2">Numero de personas</th>
		...
		<?php 
			...
			$query = mysqli_query($conexion, "SELECT tarticulos.id, tarticulos.Nombre, tarticulos.Stock, tarticulos.Cantidad, tarticulos.NPersonas, tarticulos.Descripcion, FORMAT(tarticulos.Precio, 2) AS moneda, 
													...
													WHERE tarticulos.TCategoria_id = 2 ORDER BY tarticulos.Nombre ASC");
			...
			?>
				...
				<?php	}?>
					...
					<td><a href="editar_pasteleria.php?id=<?php echo $data["id"]; ?>"><i class="fa-regular fa-pen-to-square"></i></a></td>
					<td><a href="eliminar_pasteleria.php?id=<?php echo $data["id"]; ?>" onclick="return confirmacion()"><i class="fa-solid fa-trash-can"></i></a></td>
				</tr>	
			<?php
				}
			}
					...
					<table>
						...
						<tr>
							...
							<td>
								<div id="content-select">
									<?php
										$query_categoria = mysqli_query($conexion, "SELECT id, Categoria FROM tcategoria WHERE id = 2");
