...
if(isset($_SESSION['troles'])){
    switch($_SESSION['troles']){
        case 1:
            header('Location: pagina_pasteleria.php');
        break;
...
if(isset($_POST['iniciar'])){
    if(isset($_POST['Username']) && isset($_POST['Contrasena'])){
        ...
        if($row == true){
        	...
        	echo "<div id='login_usuario'>Nombre de usuario o contraseña incorrecto  <a class='btn' href='pagina_pasteleria.php'><button class='btn'>Aceptar</button></a></div>";
        }
