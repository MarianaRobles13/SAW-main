...
<head>
	...
	<div class="ventana" id="vent">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a class="dropdown-item" href="registros_mensajes.php"><div class="pageSelected">Mensajes</div></a></li>
						</ul>
					</li>
        ...
        <table id="tabla1">
		<tr><th colspan="12"><h1>Mensajes recibidos</h1></th></tr>
		<tr>
			<th rowspan="2">Nombre completo</th>
			<th rowspan="2">E-mail/Correo</th>
			<th rowspan="2">Telefono</th>
			<th rowspan="2">Mensaje</th>
            <th rowspan="2">Fecha del mensaje</th>
		...
		<?php 
			...
			$query = mysqli_query($conexion, "SELECT * FROM tcontacto 
			...
			?>
				<tr>
					<td><?php echo $data["Nombre_contact"]; ?></td>
					<td><?php echo $data["E_mail_contact"]; ?></td>
					<td><?php echo $data["Telefono_contact"]; ?></td>
					<td><?php echo $data["Mensaje_contact"]; ?></td>
					<td><?php echo $data["Fecha_mensaje"]; ?></td>
					
					<td><a href="eliminar_mensajes.php?id=<?php echo $data["id"]; ?>" onclick="return confirmacion()"><i class="fa-solid fa-trash-can"></i></a></td>
				</tr>	
			<?php
				}
			}
