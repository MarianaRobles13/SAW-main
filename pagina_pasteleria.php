<?php
    ...
    if(!isset($_SESSION['troles'])) {
		include 'Actions/IniciarSesion/PagePasteleria.php';
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    ...
                                    <ul class="navbar-nav mx-auto" id="menuresponsive">
                                        ...
                                        <li id="list_menu" class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                <li><a class="dropdown-item" href="#DeLinea">De línea</a></li>
						                        <li><a class="dropdown-item" href="#Personalizados">Personalizados</a></li>
                                            </ul>
                                        </li>
...
<!-------------------------------------------------- CUERPO ---------------------------------------------------------------->
		<div id="cuerpo">
			...
			<div id="DeLinea" class="etiquetas_page">De Linea</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_delinea.php';?>
			</div>

			<div id="Personalizados" class="etiquetas_page">Personalizados</div>
			<div>
				<?php include 'paginas_subcategorias/pagina_productos_personalizado.php';?>
			</div>
